    ...
    <DashboardLayout>
      <div className="space-y-8">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-slate-100">Farm Ledger</h1>
                  ...
                  <>
                    <TableRow className="bg-gray-100 dark:bg-slate-800 font-medium">
                      ...
                      const typeColor = 
                        ...
                        typeLabel === 'Purchase' ? 'bg-blue-100 text-blue-800 dark:bg-blue-500/15 dark:text-blue-300' :
                      ...
                      return (
                        <TableRow key={idx} className={`border-b border-gray-200 dark:border-slate-700 ${typeLabel === 'Payment' ? 'bg-green-50 dark:bg-emerald-500/10' : typeLabel === 'Voucher' ? 'bg-purple-50 dark:bg-purple-500/10' : typeLabel === 'Purchase' ? 'bg-blue-50/30 dark:bg-blue-500/10' : ''}`}>
